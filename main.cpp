...
int main () 
{
  ...
  cout << "________                      .__                                     .__ " << endl << "\\______ \\____________    ____ |  |__   ____   ____   __________  __ __|  |" << endl << " |    |  \\_  __ \\__  \\ _/ ___\\|  |  \\_/ __ \\ /    \\ /  ___/  _ \\|  |  \\  | " << endl << " |    `   \\  | \\// __ \\  \\___|   Y  \\  ___/|   |  \\___ (  <_> )  |  /  |" << endl << "/_______  /__|  (____  /\\___  >___|  /\\___  >___|  /____  >____/|____/|____/" << endl << "        \\/           \\/     \\/     \\/     \\/     \\/     \\/                  " << endl << endl ;

  // Intro text, user inputs their name
  cout << "Tavernkeep: Welcome to our tavern weary wanderer! Sit down, have a drink! Please, tell us yer name!" << endl << endl ;
  cout << "???: My name is: " ;
  cin >> heroname ;
  cout << endl << "Tavernkeep: Ahh, hello there " << heroname << "! Allow me to thank you for assisting in the cleanup of monsters round our town. I shall give ye directions to each of the locations in and around our town." << endl << endl << "Over at the church there, ye may restore your health to full. Out in the field, you can help us clear the monsters out to yer heart's content." << endl << endl << "Once you hit level 5 and feel ye are ready to clear out the source of these monsters,  come visit me again and I'll let ye know if I hear anything. " << endl << endl << "You depart the tavern." << endl << endl ;
  ...
  while(bossdefeatstate == 0) //Keeps player stuck in loop until final boss is defeated
  {
    ...
    if(herolocation == 1) //Church
    {
      ...
      cout << "Head Priest Anagouis: Ahh, welcome " << heroname << ". I have heard much of your deeds. Please, allow me to place a blessing upon you." << endl << endl ;
    ...
    else if(herolocation == 2) //Field
    {
      ...
      if(whichmonster == 0)
      {
        ...
        monster = "Slime" ;
        monsterattack = 3 + (herolevel - 1) ;
        monsterhp = 5 + (herolevel - 1) ;
        monsterexpgiven = 2 ;
      ...
      else if(whichmonster == 2)
      {
        ...
        monsterattack = 4 + (herolevel - 1) ;
        monsterhp = 7 + (herolevel - 1) ;
        monsterexpgiven = 4 ;
    ...
    else if (herolocation == 3) //Tavern
    {
      ...
      else if(herolevel >= 5 && cavetripchecker == 0) //User's level is greater to or equal than 5, final boss begins
      {
        ...
        cout<< "Tavernkeep: OI! Fancy seeing you again here mate! Do I have some juicy news for you! " << endl << "After speaking with other adventurers that were not unlike yerself, it turns out there is a high concentration of monsters near the Cave of Eld. I might suggest you take a look there!" << endl << endl ;
      ...
      else if(herolevel >= 5 && cavetripchecker == 1) //User's level is greater to or equal than 5 and second attempt or beyond for boss fight 
      {
        ...
        cout << endl << " Tavernkeep: OI! I hear about yer defeat friend. Don't give it too much thought! Get back out there and show 'em who's who!" << endl << endl ;

        cout << "You depart the tavern and head for the Cave of Eld." << endl << endl ;

        cout << " Drachensoul: IT SEEMS YOU HATH NOT LEARNED YOUR LESSON FROM YOUR FIRST ATTEMPT. COME FORTH WITH YOUR BLADE IN HAND." << endl << endl;
  ...
  cout << "Tavernkeep: OI! We heard the news mate! Congratulations on bein the stuff of legends! No longer shall we be plagued with monsters! Ye are a certified hero, and we are throwing a celebration for ye!" << endl << endl ;

  cout << "Congratulations on your victory over Drachensoul, " << heroname << "! Here are your stats:" << endl ;
